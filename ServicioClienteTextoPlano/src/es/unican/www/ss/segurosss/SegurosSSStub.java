...
/*
 *  SegurosSSStub java implementation
 */
public class SegurosSSStub extends org.apache.axis2.client.Stub {
    private static int counter = 0;

    //http://localhost:8080/axis2/services/SegurosSS/
     ...
     * Default Constructor
     */
    public SegurosSSStub() throws org.apache.axis2.AxisFault {
        this("http://localhost:8080/axis2/services/SegurosSS/");
    }

    /**
     * Constructor taking the target endpoint
     */
    public SegurosSSStub(java.lang.String targetEndpoint)
        throws org.apache.axis2.AxisFault {
    ...
    private void populateAxisService() throws org.apache.axis2.AxisFault {
        ...
        _service = new org.apache.axis2.description.AxisService("SegurosSS" +
                getUniqueSuffix());
        ...
        __operation.setName(new javax.xml.namespace.QName(
                "http://www.unican.es/ss/SegurosSS/", "retornarListaSeguros"));
        _service.addOperation(__operation);
    ...
    private void populateFaults() {
        faultExceptionNameMap.put(new org.apache.axis2.client.FaultMapKey(
                new javax.xml.namespace.QName(
                    "http://www.unican.es/ss/SegurosSS/types/", "DatosNoValidos"),
                "RetornarDatosSeguro"),
            "es.unican.www.ss.segurosss.DatosNoValidosException");
        ...
        faultMessageMap.put(new org.apache.axis2.client.FaultMapKey(
                new javax.xml.namespace.QName(
                    "http://www.unican.es/ss/SegurosSS/types/", "DatosNoValidos"),
                "RetornarDatosSeguro"),
            "es.unican.ss.segurosss.types.DatosNoValidos");

        faultExceptionNameMap.put(new org.apache.axis2.client.FaultMapKey(
                new javax.xml.namespace.QName(
                    "http://www.unican.es/ss/SegurosSS/types/", "DatosNoValidos"),
                "RetornarListaSeguros"),
            "es.unican.www.ss.segurosss.DatosNoValidosException");
        faultExceptionClassNameMap.put(new org.apache.axis2.client.FaultMapKey(
                new javax.xml.namespace.QName(
                    "http://www.unican.es/ss/SegurosSS/types/", "DatosNoValidos"),
     ...
     * @see es.unican.www.ss.segurosss.SegurosSS#retornarDatosSeguro
     * @param retornarDatosSeguro
     * @throws es.unican.www.ss.segurosss.DatosNoValidosException :
     */
    public es.unican.ss.segurosss.types.InfoSeguro retornarDatosSeguro(
        java.lang.String retornarDatosSeguro)
        ...
        try {
            ...
            _operationClient.getOptions()
                            .setAction("http://www.unican.es/ss/SegurosSS/RetornarDatosSeguro");
            ...
            env = toEnvelope(getFactory(_operationClient.getOptions()
                    ...
                    optimizeContent(
                        new javax.xml.namespace.QName(
                            "http://www.unican.es/ss/SegurosSS/",
                            "retornarDatosSeguro")),
                    new javax.xml.namespace.QName(
            ...
            return (es.unican.ss.segurosss.types.InfoSeguro) object;
            ...
            if (faultElt != null) {
                if (faultExceptionNameMap.containsKey(
                            new org.apache.axis2.client.FaultMapKey(
                                faultElt.getQName(), "RetornarDatosSeguro"))) {
                    ...
                    try {
                        ...
                        if (ex instanceof es.unican.www.ss.segurosss.DatosNoValidosException) {
                            throw (es.unican.www.ss.segurosss.DatosNoValidosException) ex;
                        }
     ...
     * @see es.unican.www.ss.segurosss.SegurosSS#retornarListaSeguros
     * @param retornarListaSeguros
     * @throws es.unican.www.ss.segurosss.DatosNoValidosException :
     */
    public es.unican.ss.segurosss.types.ListaSeguros retornarListaSeguros(
        java.lang.String retornarListaSeguros)
        throws java.rmi.RemoteException,
            es.unican.www.ss.segurosss.DatosNoValidosException {
        org.apache.axis2.context.MessageContext _messageContext = new org.apache.axis2.context.MessageContext();
        ...
        try {
            ...
            _operationClient.getOptions()
                            .setAction("http://www.unican.es/ss/SegurosSS/RetornarListaSeguros");
            _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
            ...
            return (es.unican.ss.segurosss.types.ListaSeguros) object;
        } catch (org.apache.axis2.AxisFault f) {
            org.apache.axiom.om.OMElement faultElt = f.getDetail();
            ...
            if (faultElt != null) {
                if (faultExceptionNameMap.containsKey(
                            new org.apache.axis2.client.FaultMapKey(
                                faultElt.getQName(), "RetornarListaSeguros"))) {
                    //make the fault by reflection
                    try {
                        java.lang.String exceptionClassName = (java.lang.String) faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(
                                    faultElt.getQName(), "RetornarListaSeguros"));
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.unican.ss.segurosss.types.DatosNoValidos param,
        boolean optimizeContent, javax.xml.namespace.QName elementQName)
        throws org.apache.axis2.AxisFault {
        org.apache.axiom.om.OMFactory factory = org.apache.axiom.om.OMAbstractFactory.getOMFactory();
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.unican.ss.segurosss.types.ListaSeguros param,
        boolean optimizeContent, javax.xml.namespace.QName elementQName)
        throws org.apache.axis2.AxisFault {
        org.apache.axiom.om.OMFactory factory = org.apache.axiom.om.OMAbstractFactory.getOMFactory();
